...
//shared class variables
	...
	static GamePanel hWord;// adding hungryword onto the 
	static HungryWordMover []hWordMover;
	static ScoreUpdater scoreD ;
	static Thread gameWindowThread;
	static Thread scoreThread;
	static Thread hungryWordThread; // thrad to handle the hungry word to ensure randomness
	...
	public static void setupGUI(int frameX,int frameY,int yLimit) {
		...
		gameWindow = new GamePanel(words,hWordMover, yLimit,done,started,won);
		gameWindow.setSize(frameX,yLimit+100);
	    g.add(gameWindow);

		//wanting to add the hungry word onto the screen
		//hWord = new GamePanel(words, hWordMover, yLimit, done, started, won);
	...
	public static void createWordMoverThreads() {
		...
		hWordMover[0] = new HungryWordMover(dict, dict.getNewWord(), 100, gameWindow.getWidth(), startLatch, done, pause);
		hWordMover[0].start();
	...
	//need a hungry word mover threads
...
public static void main(String[] args) {
		...
		hWordMover = new HungryWordMover[1];
